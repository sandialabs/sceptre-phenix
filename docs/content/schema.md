...
The following schemas are all represented using the `OpenAPIv3` format. The
complete schema is [described here](#complete-schema).
...
```yaml
--8<--
src/go/types/version/schemas/v2.yaml
--8<--
```
