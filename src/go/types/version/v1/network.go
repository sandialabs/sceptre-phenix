...
type Network struct {
	...
	NATF        []NAT        `json:"nat"        mapstructure:"nat"        structs:"nat"        yaml:"nat"`
}
...
func (n *Network) NAT() []ifaces.NodeNetworkNAT {
	if n == nil {
		return nil
	}

	nat := make([]ifaces.NodeNetworkNAT, len(n.NATF))

	for i, n := range n.NATF {
		nat[i] = n
	}
...
type Interface struct {
	...
	BridgeSetInTopo *bool `json:"-" mapstructure:"bridge_set_in_topo,omitempty" structs:"bridge_set_in_topo,omitempty" yaml:"-"`
}
...
func (a AreaNetwork) Network() string {
	return a.NetworkF
}
...
type Rule struct {
	...
	StatefulF    bool      `json:"stateful"    mapstructure:"stateful"    structs:"stateful"    yaml:"stateful"`
}
...
func (r *Rule) SetStateful(s bool) {
	r.StatefulF = s
}
...
type NAT struct {
	InF  []string `json:"in"  mapstructure:"in"  structs:"in"  yaml:"in"`
	OutF string   `json:"out" mapstructure:"out" structs:"out" yaml:"out"`
}

func (n NAT) In() []string {
	return n.InF
}

func (n NAT) Out() string {
	return n.OutF
}

func (n *Network) SetDefaults(bridge string) {
