...
type StringArray util.StringArray
...
type Interface struct {
	...
	DNSF        StringArray `json:"dns" yaml:"dns" structs:"dns" mapstructure:"dns"`
...
func (this Interface) DNS() StringArray {
	return this.DNSF
}
...
func (this *Interface) SetDNS(dns StringArray) {
	for _, value := range dns {
		this.DNSF = append(this.DNSF, value)
	}
}
