...
Menus.prototype.init = function()
{
        ...
        {
        //   this.addMenuItems(menu, ['new', 'open', '-', 'save', 'saveAs', '-', 'import', 'export', '-', 'pageSetup', 'print', '-', 'viewJSON', 'editVariables'], parent);
          this.addMenuItems(menu, ['new', 'viewJSON', 'open', '-', 'save', 'import', '-', 'editVariables', '-', 'pageSetup', 'print'], parent);
        })));
