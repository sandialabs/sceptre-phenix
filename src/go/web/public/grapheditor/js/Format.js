...
Format.prototype.refresh = function()
{
        ...
        // phenix: upstream tops the 25px tab off with 8px of padding, which
        // assumed a ~15px line box. bootstrap.css raises the line height to
        // 18.57px, so the text overflowed the tab and sat low. Centre it with
        // line-height inside a border-box tab instead.
