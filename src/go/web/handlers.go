...
func StartVM(w http.ResponseWriter, r *http.Request) {
	...
	if err := lockVMForStarting(expName, name); err != nil {
		log.Warn(err.Error())
		http.Error(w, err.Error(), http.StatusConflict)
		return
	}

	defer unlockVM(expName, name)
...
func StopVM(w http.ResponseWriter, r *http.Request) {
	...
	if err := lockVMForStopping(expName, name); err != nil {
		log.Warn(err.Error())
		http.Error(w, err.Error(), http.StatusConflict)
		return
	}
...
func RedeployVM(w http.ResponseWriter, r *http.Request) {
	...
	if err := lockVMForRedeploying(expName, name); err != nil {
		log.Warn(err.Error())
		http.Error(w, err.Error(), http.StatusConflict)
		return
	}
...
func CommitVM(w http.ResponseWriter, r *http.Request) {
	...
	if err := lockVMForCommitting(expName, name); err != nil {
		log.Warn(err.Error())
		http.Error(w, err.Error(), http.StatusConflict)
		return
	}
