...
... or ...
	...
	$> bin/phenix config get scenario/foo-bar-scenario
...
You can manage runtime settings (like log levels) via:

	$> bin/phenix settings set log.level debug
	$> bin/phenix settings list
*/
package main
